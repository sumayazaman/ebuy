...
<html lang="en">
  <head>
    ...
    <title>ebuy | Admin - @yield('title', 'Home Page')</title>
    ...
    <!-- Starlight CSS -->
    <link href="{{ asset('starlight/css/starlight.css') }}" rel="stylesheet">
  </head>
            ...
            <a href="" class="media-list-link">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke at the present moment{{ asset('starlight')}}.</p>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="tx-13 mg-t-10 mg-b-0">When, while the lovely valley teems with vapour around me, and the meridian sun strikes{{ asset('starlight')}}.</p>
                </div>
              </div><!-- media -->
            </a>
            <a href="" class="media-list-link">
